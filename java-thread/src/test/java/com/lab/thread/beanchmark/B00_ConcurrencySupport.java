...
@Slf4j
public class B00_ConcurrencySupport {

    public static final int USERS = 10;
    public static final int PERSISTENCE_FORK_FACTOR = 3;

    public static final long SERVICE_A_LATENCY = 1000;
    public static final long SERVICE_B_LATENCY = 500;
    public static final long PERSISTENCE_LATENCY = 300;
